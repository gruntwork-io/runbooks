...
func TestParseBoilerplateConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			filename:              "../testdata/boilerplate/boilerplate.yml",
			wantErr:               false,
		...
		},
		{
			...
			filename:              "../testdata/boilerplate/boilerplate-with-validations.yml",
			wantErr:               false,
		...
		},
		{
			...
			filename: "../testdata/boilerplate/non-existent.yml",
			wantErr:  true,
		},
		{
			name:     "invalid variable types",
			filename: "../testdata/boilerplate/invalid-variable-types.yml",
			wantErr:  true,
		},
		{
			name:                  "invalid validations",
			filename:              "../testdata/boilerplate/invalid-validations.yml",
		...
		},
		{
			...
			filename: "../testdata/boilerplate/invalid-yaml-syntax-2.yml",
			wantErr:  true,
		},
	}
...
func TestParseBoilerplateConfig_ValidationRules(t *testing.T) {
	absPath, err := filepath.Abs("../testdata/boilerplate/boilerplate-with-validations.yml")
	require.NoError(t, err)
...
func TestParseBoilerplateConfig_EnumVariables(t *testing.T) {
	absPath, err := filepath.Abs("../testdata/boilerplate/enum-only.yml")
	require.NoError(t, err)
...
func TestParseBoilerplateConfig_ComplexDefaults(t *testing.T) {
	absPath, err := filepath.Abs("../testdata/boilerplate/complex-defaults.yml")
	require.NoError(t, err)
