...
Template files can reference outputs from other blocks (e.g., [Command](/authoring/blocks/command/), [Check](/authoring/blocks/check/), [TfModule](/authoring/blocks/tfmodule/), [DirPicker](/authoring/blocks/dirpicker/)) using the `_blocks` namespace:
