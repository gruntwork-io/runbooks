...
Check out the [block-outputs feature demo](https://github.com/gruntwork-io/runbooks/tree/main/testdata/feature-demos/block-outputs) for a complete working demonstration of Template blocks that consume outputs from upstream Command blocks.
</Aside>
