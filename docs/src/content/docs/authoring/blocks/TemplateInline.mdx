...
Check out the [demo-runbook-outputs](https://github.com/gruntwork-io/runbooks/tree/main/testdata/demo-runbook-outputs) example for a complete working demonstration of TemplateInline blocks that consume outputs from upstream Command blocks, including examples of iterating over lists and maps.
</Aside>
