...
jobs:
  test:
    ...
    steps:
      ...
      - name: Run runbook tests
        run: resources/bin/runbooks-test test ./runbooks/... --output junit --output-file results.xml
        env:
          RUNBOOKS_TEST_AWS_ACCESS_KEY_ID: ${{ env.AWS_ACCESS_KEY_ID }}
          RUNBOOKS_TEST_AWS_SECRET_ACCESS_KEY: ${{ env.AWS_SECRET_ACCESS_KEY }}
          RUNBOOKS_TEST_AWS_SESSION_TOKEN: ${{ env.AWS_SESSION_TOKEN }}
...
test-runbooks:
  ...
  before_script:
    ...
    - just compile-test-cli
  script:
    - resources/bin/runbooks-test test ./runbooks/... --output junit --output-file results.xml
  artifacts:
    reports:
      junit: results.xml
```
