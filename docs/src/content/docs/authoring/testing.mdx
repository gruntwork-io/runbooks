...
jobs:
  test:
    ...
    steps:
      ...
      - name: Install runbooks-cli
        run: npm install -g @gruntwork-io/runbooks-cli
      ...
      - name: Run runbook tests
        run: runbooks-cli test ./runbooks/... --output junit --output-file results.xml
        env:
...
test-runbooks:
  ...
  script:
    - npm install -g @gruntwork-io/runbooks-cli
    - runbooks-cli test ./runbooks/... --output junit --output-file results.xml
  artifacts:
    reports:
      junit: results.xml
