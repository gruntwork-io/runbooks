...
- `--watch` - Enable watch mode for live-reload during authoring. See [watch mode](/commands/watch) for details.
...
2. **Launches the Electron app** - Opens the Runbooks desktop app and loads the specified runbook
