...
# Terraform/OpenTofu module source format
...
| Terraform GitHub shorthand | `github.com/org/repo//path?ref=v1.0` |
| Terraform git::https | `git::https://host/org/repo.git//path?ref=main` |
