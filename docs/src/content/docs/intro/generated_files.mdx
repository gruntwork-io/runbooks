...
### 2. Command blocks with $GENERATED_FILES
...
Any files written to `$GENERATED_FILES` automatically appear in your generated files after the command completes successfully.
...
- **Command/Check blocks**: Create subdirectories within `$GENERATED_FILES`.
