...
For a problem statement that can be summarized in one sentence, the solutions avilable for Landing Zones are surprisingly complex and often treat infrastructure-as-code as a second-class citizen.
...
Because Runbooks can ask for a user-entered value like an AWS account ID, you can plum this value through your generated code and scripts to accomplish whatever you need.
