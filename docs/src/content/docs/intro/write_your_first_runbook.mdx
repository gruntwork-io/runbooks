...
<SourceFile file="testdata/sample-runbooks/my-first-runbook/runbook.mdx" lang="mdx" title="runbook.mdx" />

<SourceFile file="testdata/sample-runbooks/my-first-runbook/scripts/setup.sh" lang="bash" title="scripts/setup.sh" />
...
<SourceFile file="testdata/sample-runbooks/my-first-runbook/templates/project/boilerplate.yml" lang="yaml" title="templates/project/boilerplate.yml" />

<SourceFile file="testdata/sample-runbooks/my-first-runbook/templates/project/README.md" lang="markdown" title="templates/project/README.md" />

<SourceFile file="testdata/sample-runbooks/my-first-runbook/templates/project/.gitignore" lang="text" title="templates/project/.gitignore" />
