...
require (
	...
	go.opentelemetry.io/otel v1.41.0 // indirect; indirect from boilerplate
	go.opentelemetry.io/otel/metric v1.41.0 // indirect; indirect from boilerplate
	...
	go.opentelemetry.io/otel/trace v1.41.0 // indirect; indirect from boilerplate
