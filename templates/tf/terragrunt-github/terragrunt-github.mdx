...
<GitHubPullRequest
  ...
  prefilledPullRequestTitle="Update {{ ._blocks.target_path.outputs.MODULE_NAME }} module"
  prefilledBranchName="feature/{{ ._blocks.target_path.outputs.MODULE_NAME }}"
  prefilledPullRequestDescription="## Changes\n\n- Added a new terragrunt.hcl file at {{ ._blocks.target_path.outputs.TARGET_PATH }}"
/>
