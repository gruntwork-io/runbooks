...
<Check
  id="check-mise"
  command="echo 'hello4'; mise --version && mise self-update;"
...
<Command
  id="install-tools"
  command="echo 'hello3'; mise use terragrunt@latest opentofu@latest awscli@latest granted@latest gh@latest"
