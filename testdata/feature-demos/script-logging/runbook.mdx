...
For local development, run this one-liner in your terminal to simulate the Runbooks environment:
...
This sets `BASH_ENV` so bash sources the logging functions before running any script. No changes to your scripts are needed — the same script works in both environments.
