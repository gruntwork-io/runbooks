...
## Now here's a code snippet:

<BoilerplateTemplate boilerplateInputsId="test">
```hcl
terraform {
...
<BoilerplateTemplate boilerplateInputsId="standalone-example" variables={{ AccountName: "Production", Environment: "prod" }}>
```hcl
