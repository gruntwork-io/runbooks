...
<BoilerplateTemplate boilerplateInputsId="test" outputPath="sample.hcl">
```hcl
...
## Now here's code snippet 2:

<BoilerplateTemplate boilerplateInputsId="test" outputPath="/a/b.hcl" initialVariables={{ AccountName: "Production", Environment: "prod", Tags: {} }}>
```hcl
terraform {
