...
<BoilerplateTemplate boilerplateInputsId="test" variables={{ AccountName: "Production" }}>
```hcl
...
<BoilerplateTemplate boilerplateInputsId="test" variables={{ AccountName: "Production", Environment: "prod" }}>
```hcl
terraform {
