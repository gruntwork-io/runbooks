...
<Check id="test" title="Check if the check worked" description="This check should warn" path="checks/check-warning.sh" successMessage="Success" warnMessage="Warn" failMessage="Fail" />
