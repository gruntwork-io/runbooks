# Error Scenarios Test Gruntbook

This gruntbook demonstrates how errors are displayed to users for each block type.
...
<Command 
  id="cmd-missing-vars" 
  command="echo 'Hello {{ .inputs.name }}, welcome to {{ .inputs.location }}!'"
