...
#
# This script is designed to be called from the gruntbook Command block, which
...
# Parse arguments (automatically passed from boilerplate inputs in the gruntbook)
