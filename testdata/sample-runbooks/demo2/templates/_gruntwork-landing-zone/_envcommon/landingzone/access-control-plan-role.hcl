...
inputs = {
  ...
  allowed_sources = {
    "{{ .inputs.SCMProviderGroup }}/{{ .inputs.AccessControlRepoName }}" : ["*"]
  }

  custom_iam_policy_name = "access-control-pipelines-plan-oidc-policy"
  iam_role_name          = "access-control-pipelines-plan"
