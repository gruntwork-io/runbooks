...
import { test, expect, expectNoConsoleErrors, trustGruntbook, deleteFilesIfPrompted, getFilesPanel, createLocalBareRepo } from "./fixtures";

/**
 * End-to-end tests for the sample gruntbooks in testdata/sample-gruntbooks/.
 *
 * Each test starts a fresh server, loads the gruntbook in a real browser, and
...
// Test: demo1
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/demo1", () => {
  test("renders demo1 without errors", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/demo1");
...
// Test: demo2
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/demo2", () => {
  test("renders demo2 without errors", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/demo2");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
  ...
  test("renders the large input form and generates files", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/demo2");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
...
// Test: demo3
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/demo3", () => {
  test("renders all blocks without errors", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/demo3");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
    ...
    // Verify the title rendered.
    await expect(page.locator("h1")).toHaveText("Demo Gruntbook 3");
    ...
    await expect(inputsBlock.getByRole("textbox", { name: /GitHub Repo Name/i })).toHaveValue("gruntbooks-infrastructure-live-example");
  ...
  test("runs a command with embedded inputs and shows success", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/demo3");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
  ...
  test("generates files from Template block and shows them in file panel", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/demo3");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
...
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/markdown-only-full", () => {
  test("renders all markdown elements correctly", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/markdown-only-full");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
...
// ---------------------------------------------------------------------------
// Test: my-first-gruntbook
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/my-first-gruntbook", () => {
  test("renders MDX content with all block types", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/my-first-gruntbook");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
    ...
    // Verify the title.
    await expect(page.locator("h1")).toHaveText("My First Gruntbook");
  ...
  test("generates template files and shows them in the file panel", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/my-first-gruntbook");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
...
// Test: homepage-demo
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/homepage-demo", () => {
  test("renders without errors", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/homepage-demo");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
  ...
  test("runs check and command blocks", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/homepage-demo");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
...
// Test: next-app
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/next-app", () => {
  test("renders all blocks and interactive forms without errors", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/next-app");
    await page.goto(`http://localhost:${serverPort}/`);
    await deleteFilesIfPrompted(page);
  ...
  test("generates welcome-card template files", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
...
// ---------------------------------------------------------------------------
test.describe("sample-gruntbooks/dual-clone", () => {
  test("Command blocks propagate CWD to subsequent commands", async ({ page, serveGruntbook, serverPort, consoleMessages }) => {
    await serveGruntbook("testdata/sample-gruntbooks/dual-clone");
    await page.goto(`http://localhost:${serverPort}/`);
  ...
  test("GitClone resolves paths relative to initial workDir after cd (issue #94)", async ({ page, serveGruntbook, serverPort, workDir, consoleMessages }) => {
