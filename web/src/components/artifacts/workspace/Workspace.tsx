      ...
      <div className={cn("w-full h-full flex flex-col", className)}>
        <div className="flex items-center justify-between py-2 px-3">
          ...
          {onHide && (
            <button
              onClick={onHide}
              className="hidden lg:block p-2 border border-border rounded-lg hover:bg-accent transition-all duration-200 cursor-pointer"
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center px-8">
            <FolderOpen className="w-16 h-16 mx-auto mb-3 text-muted-foreground" />
    ...
    <div className={cn("w-full h-full flex flex-col", className)}>
      ...
      {isRepositoryView && (
        <>
          ...
          <div className="flex items-end px-3 border-b border-border">
            <RepositoryTabs
              activeTab={activeTab}
