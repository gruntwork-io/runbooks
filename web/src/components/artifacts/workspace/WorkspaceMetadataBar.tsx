...
/**
 * GitHub Invertocat icon (official logo)
 */
const GitHubIcon: React.FC<SVGProps<SVGSVGElement> & { className?: string }> = ({ className, ...props }) => (
  <svg
  ...
  return (
    <div className={cn("py-2.5", className)}>
      ...
      <div className="flex items-center gap-1.5 text-sm">
        ...
        <a
          href={gitInfo.repoUrl.startsWith('http') ? gitInfo.repoUrl : `https://${gitInfo.repoUrl}`}
          target="_blank"
