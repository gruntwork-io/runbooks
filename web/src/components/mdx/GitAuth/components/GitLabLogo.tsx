...
/**
 * GitLab "tanuki" logo. Uses the official brand fills (#E24329 / #FC6D26 /
 * #FCA326) rather than currentColor so the mark stays recognizable on the
 * status-tinted block background, mirroring how GitHubLogo renders.
 */
export function GitLabLogo({ className = "size-6", ariaLabel }: GitLabLogoProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 256 236"
