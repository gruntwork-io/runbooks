    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          Fine-grained tokens start with <code className="bg-muted px-1 rounded">github_pat_</code>, 
          classic tokens with <code className="bg-muted px-1 rounded">ghp_</code>
        </p>
      </div>
