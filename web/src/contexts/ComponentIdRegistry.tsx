...
export type BlockComponentType = 'Command' | 'Check' | 'Inputs' | 'Template' | 'TemplateInline' | 'AwsAuth' | 'GoogleAuth' | 'GitAuth' | 'GitHubAuth' | 'GitLabAuth' | 'GitClone' | 'GitPullRequest' | 'GitHubPullRequest' | 'GitLabMergeRequest' | 'DirPicker'
