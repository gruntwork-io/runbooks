...
import { GruntbookContextProvider } from './GruntbookContext'
import { useGruntbookContext } from './useGruntbook'
import { BoilerplateVariableType } from '@/types/boilerplateVariable'
import { makeConfig } from '@/test/make-config'

function createWrapper(props?: { remoteSource?: string; gruntbookName?: string }) {
  return function Wrapper({ children }: { children: ReactNode }) {
    return (
      <GruntbookContextProvider
        gruntbookName={props?.gruntbookName}
...
describe('GruntbookContext', () => {
  describe('remoteSource', () => {
    it('provides remoteSource from provider props', () => {
      const { result } = renderHook(() => useGruntbookContext(), {
